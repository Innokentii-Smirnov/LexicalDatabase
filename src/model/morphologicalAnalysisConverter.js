function convertSingleMorphAnalysisWithoutEncliticsToMultiMorphAnalysis({ analysis, selected, ...rest }) {
    return {
        ...rest,
...
function convertSingleMorphAnalysisWithSingleEncliticsToMultiMorphAnalysis({ analysis, selected, ...rest }) {
    return {
        ...rest,
...
function convertSingleMorphAnalysisWithMultiEncliticsToMultiMorphAnalysis({ analysis, ...rest }) {
    return {
        ...rest,
...
export function convertSingleMorphAnalysisToMultiMorphAnalysis(sma) {
    switch (sma._type) {
