...
curl localhost:8080 | jq '.corpus["KBo 51.228+, {€1} Vs. 13′"]'
curl localhost:8080 | jq '.dictionary["pindaianni"]'
curl localhost:8080 | jq '.concordance["pindaianni @ meaning unknown @ .ABS @ subst @ "]'
curl localhost:8080 | jq '.concordance["pindaia+nni @ u.B. @ .ABS @ noun @ "]'
